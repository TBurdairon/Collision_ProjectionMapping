...
public class SelectionManager : MonoBehaviour {
	...
	public GameObject dynamicControllersParent;
	public GameObject staticControllersParent;
	...
	void Start () {
		...
		//staticControllersParent = this.gameObject;//GameObject.Find("StaticControllers");
		...
		foreach(Transform child in staticControllersParent.transform)
		{
			...
			child.gameObject.transform.rotation = new Quaternion (0, 0, 0, 0);
